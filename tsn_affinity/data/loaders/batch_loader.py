"""Minibatch generation from trajectory lists and masked loss functions."""
...
def make_minibatches(
    ...
    Yields:
        ...
        actions: [batch_size, seq_len] action tensor (discrete,
            padded values replaced with 0)
            or [batch_size, seq_len, action_dim] (continuous).
    ...
    while True:
        batch = []
        continuous = trajs[0].actions.ndim == 2 if trajs else False
