...
class TopKMaskSTE(torch.autograd.Function):
    ...
    The forward pass selects the top-k elements by magnitude from the
    score tensor and returns a binary mask. The backward pass is the
    ...
    @staticmethod
    def backward(
        ctx: torch.autograd.function.FunctionCtx,  # noqa: ARG004
